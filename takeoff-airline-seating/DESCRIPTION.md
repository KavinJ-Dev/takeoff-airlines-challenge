# TakeOff Airlines Operation Issues
## Description:
...
What if the input is empty? What if all entries are invalid?
### Validation first: 
Check each seat to make sure it's a valid integer between 1 and 300
### Data structures: 
Some data structures automatically handle duplicates—consider using them
### Type checking: 
Make sure you're working with actual numbers, not strings or other types
### Testing: 
Try your function with various inputs to make sure it works correctly
